...
const
  ...
  OpCodes: array[Byte] of TOpCodeLUT = (
    {00} (Mode:amIMP; Instruction:inBRK; Ticks:7),
    {01} (Mode:amINX; Instruction:inORA; Ticks:6),
    {02} (Instruction:inNIL),
    {03} (Instruction:inNIL),
    {04} (Instruction:inNIL),
    {05} (Mode:amZER; Instruction:inORA; Ticks:3),
    {06} (Mode:amZER; Instruction:inASL; Ticks:5),
    {07} (Instruction:inNIL),
    {08} (Mode:amIMP; Instruction:inPHP; Ticks:3),
    {09} (Mode:amIMM; Instruction:inORA; Ticks:2),
    {0A} (Mode:amACC; Instruction:inASL; Ticks:2),
    {0B} (Instruction:inNIL),
    {0C} (Instruction:inNIL),
    {0D} (Mode:amABS; Instruction:inORA; Ticks:4),
    {0E} (Mode:amABS; Instruction:inASL; Ticks:6),
    ...
    {15} (Mode:amZEX; Instruction:inORA; Ticks:4),
    {16} (Mode:amZEX; Instruction:inASL; Ticks:6),
    {17} (Instruction:inNIL),
    {18} (Mode:amIMP; Instruction:inCLC; Ticks:2),
    ...
    {1E} (Mode:amABX; Instruction:inASL; Ticks:7),
    {1F} (Instruction:inNIL),
    {20} (Mode:amABS; Instruction:inJSR; Ticks:6),
    {21} (Mode:amINX; Instruction:inAND; Ticks:6),
    {22} (Instruction:inNIL),
    {23} (Instruction:inNIL),
    {24} (Mode:amZER; Instruction:inBIT; Ticks:3),
    {25} (Mode:amZER; Instruction:inAND; Ticks:3),
    {26} (Mode:amZER; Instruction:inROL; Ticks:5),
    {27} (Instruction:inNIL),
    {28} (Mode:amIMP; Instruction:inPLP; Ticks:4),
    {29} (Mode:amIMM; Instruction:inAND; Ticks:2),
    {2A} (Mode:amACC; Instruction:inROL; Ticks:2),
    {2B} (Instruction:inNIL),
    {2C} (Mode:amABS; Instruction:inBIT; Ticks:4),
    {2D} (Mode:amABS; Instruction:inAND; Ticks:4),
    {2E} (Mode:amABS; Instruction:inROL; Ticks:6),
    {2F} (Instruction:inNIL),
    {30} (Mode:amREL; Instruction:inBMI; Ticks:2; Penalty:ipBranch),
    {31} (Mode:amINY; Instruction:inAND; Ticks:5),
    {32} (Instruction:inNIL),
    {33} (Instruction:inNIL),
    {34} (Instruction:inNIL),
    {35} (Mode:amZEX; Instruction:inAND; Ticks:4),
    {36} (Mode:amZEX; Instruction:inROL; Ticks:6),
    {37} (Instruction:inNIL),
    {38} (Mode:amIMP; Instruction:inSEC; Ticks:2),
    ...
    {3E} (Mode:amABX; Instruction:inROL; Ticks:7),
    {3F} (Instruction:inNIL),
    {40} (Mode:amIMP; Instruction:inRTI; Ticks:6),
    {41} (Mode:amINX; Instruction:inEOR; Ticks:6),
    {42} (Instruction:inNIL),
    {43} (Instruction:inNIL),
    {44} (Instruction:inNIL),
    {45} (Mode:amZER; Instruction:inEOR; Ticks:3),
    {46} (Mode:amZER; Instruction:inLSR; Ticks:5),
    {47} (Instruction:inNIL),
    {48} (Mode:amIMP; Instruction:inPHA; Ticks:3),
    {49} (Mode:amIMM; Instruction:inEOR; Ticks:2),
    {4A} (Mode:amACC; Instruction:inLSR; Ticks:2),
    {4B} (Instruction:inNIL),
    {4C} (Mode:amABS; Instruction:inJMP; Ticks:3),
    {4D} (Mode:amABS; Instruction:inEOR; Ticks:4),
    {4E} (Mode:amABS; Instruction:inLSR; Ticks:6),
    ...
    {55} (Mode:amZEX; Instruction:inEOR; Ticks:4),
    {56} (Mode:amZEX; Instruction:inLSR; Ticks:6),
    {57} (Instruction:inNIL),
    {58} (Mode:amIMP; Instruction:inCLI; Ticks:2),
    {59} (Mode:amABY; Instruction:inEOR; Ticks:4; Penalty:ipPageCross),
    {5A} (Mode:amIMP; Instruction:inPHY; Ticks:3),
    {5B} (Instruction:inNIL),
    {5C} (Instruction:inNIL),
    {5D} (Mode:amABX; Instruction:inEOR; Ticks:4; Penalty:ipPageCross),
    {5E} (Mode:amABX; Instruction:inLSR; Ticks:7),
    {5F} (Instruction:inNIL),
    {60} (Mode:amIMP; Instruction:inRTS; Ticks:6),
    {61} (Mode:amINX; Instruction:inADC; Ticks:6),
    {62} (Instruction:inNIL),
    {63} (Instruction:inNIL),
    {64} (Mode:amZER; Instruction:inSTZ; Ticks:3),
    {65} (Mode:amZER; Instruction:inADC; Ticks:3),
    {66} (Mode:amZER; Instruction:inROR; Ticks:5),
    {67} (Instruction:inNIL),
    {68} (Mode:amIMP; Instruction:inPLA; Ticks:4),
    {69} (Mode:amIMM; Instruction:inADC; Ticks:2),
    {6A} (Mode:amACC; Instruction:inROR; Ticks:2),
    {6B} (Instruction:inNIL),
    {6C} (Mode:amAIN; Instruction:inJMP; Ticks:5),
    {6D} (Mode:amABS; Instruction:inADC; Ticks:4),
    {6E} (Mode:amABS; Instruction:inROR; Ticks:6),
    ...
    {74} (Mode:amZEX; Instruction:inSTZ; Ticks:4),
    {75} (Mode:amZEX; Instruction:inADC; Ticks:4),
    {76} (Mode:amZEX; Instruction:inROR; Ticks:6),
    {77} (Instruction:inNIL),
    {78} (Mode:amIMP; Instruction:inSEI; Ticks:2),
    ...
    {7E} (Mode:amABX; Instruction:inROR; Ticks:7),
    {7F} (Instruction:inNIL),
    {80} (Mode:amREL; Instruction:inBRA; Ticks:3; Penalty:ipPageCross),
    {81} (Mode:amINX; Instruction:inSTA; Ticks:6),
    {82} (Instruction:inNIL),
    {83} (Instruction:inNIL),
    {84} (Mode:amZER; Instruction:inSTY; Ticks:3),
    {85} (Mode:amZER; Instruction:inSTA; Ticks:3),
    {86} (Mode:amZER; Instruction:inSTX; Ticks:3),
    {87} (Instruction:inNIL),
    {88} (Mode:amIMP; Instruction:inDEY; Ticks:2),
    {89} (Instruction:inNIL),
    {8A} (Mode:amIMP; Instruction:inTXA; Ticks:2),
    {8B} (Instruction:inNIL),
    {8C} (Mode:amABS; Instruction:inSTY; Ticks:4),
    {8D} (Mode:amABS; Instruction:inSTA; Ticks:4),
    {8E} (Mode:amABS; Instruction:inSTX; Ticks:4),
    {8F} (Instruction:inNIL),
    {90} (Mode:amREL; Instruction:inBCC; Ticks:2; Penalty:ipBranch),
    {91} (Mode:amINY; Instruction:inSTA; Ticks:6),
    {92} (Instruction:inNIL),
    {93} (Instruction:inNIL),
    {94} (Mode:amZEX; Instruction:inSTY; Ticks:4),
    {95} (Mode:amZEX; Instruction:inSTA; Ticks:4),
    {96} (Mode:amZEY; Instruction:inSTX; Ticks:4),
    {97} (Instruction:inNIL),
    {98} (Mode:amIMP; Instruction:inTYA; Ticks:2),
    {99} (Mode:amABY; Instruction:inSTA; Ticks:5),
    {9A} (Mode:amIMP; Instruction:inTXS; Ticks:2),
    {9B} (Instruction:inNIL),
    {9C} (Mode:amABS; Instruction:inSTZ; Ticks:4),
    {9D} (Mode:amABX; Instruction:inSTA; Ticks:5),
    {9E} (Mode:amABX; Instruction:inSTZ; Ticks:5),
    {9F} (Instruction:inNIL),
    {A0} (Mode:amIMM; Instruction:inLDY; Ticks:2),
    {A1} (Mode:amINX; Instruction:inLDA; Ticks:6),
    {A2} (Mode:amIMM; Instruction:inLDX; Ticks:2),
    {A3} (Instruction:inNIL),
    {A4} (Mode:amZER; Instruction:inLDY; Ticks:3),
    {A5} (Mode:amZER; Instruction:inLDA; Ticks:3),
    {A6} (Mode:amZER; Instruction:inLDX; Ticks:3),
    {A7} (Instruction:inNIL),
    {A8} (Mode:amIMP; Instruction:inTAY; Ticks:2),
    {A9} (Mode:amIMM; Instruction:inLDA; Ticks:2),
    {AA} (Mode:amIMP; Instruction:inTAX; Ticks:2),
    {AB} (Instruction:inNIL),
    {AC} (Mode:amABS; Instruction:inLDY; Ticks:4),
    {AD} (Mode:amABS; Instruction:inLDA; Ticks:4),
    {AE} (Mode:amABS; Instruction:inLDX; Ticks:4),
    ...
    {B4} (Mode:amZEX; Instruction:inLDY; Ticks:4),
    {B5} (Mode:amZEX; Instruction:inLDA; Ticks:4),
    {B6} (Mode:amZEY; Instruction:inLDX; Ticks:4),
    {B7} (Instruction:inNIL),
    {B8} (Mode:amIMP; Instruction:inCLV; Ticks:2),
    {B9} (Mode:amABY; Instruction:inLDA; Ticks:4; Penalty:ipPageCross),
    {BA} (Mode:amIMP; Instruction:inTSX; Ticks:2),
    ...
    {C0} (Mode:amIMM; Instruction:inCPY; Ticks:2),
    {C1} (Mode:amINX; Instruction:inCMP; Ticks:6),
    {C2} (Instruction:inNIL),
    {C3} (Instruction:inNIL),
    {C4} (Mode:amZER; Instruction:inCPY; Ticks:3),
    {C5} (Mode:amZER; Instruction:inCMP; Ticks:3),
    {C6} (Mode:amZER; Instruction:inDEC; Ticks:5),
    {C7} (Instruction:inNIL),
    {C8} (Mode:amIMP; Instruction:inINY; Ticks:2),
    {C9} (Mode:amIMM; Instruction:inCMP; Ticks:2),
    {CA} (Mode:amIMP; Instruction:inDEX; Ticks:2),
    {CB} (Mode:amIMP; Instruction:inWAI; Ticks:3),
    {CC} (Mode:amABS; Instruction:inCPY; Ticks:4),
    {CD} (Mode:amABS; Instruction:inCMP; Ticks:4),
    {CE} (Mode:amABS; Instruction:inDEC; Ticks:3),
    ...
    {D5} (Mode:amZEX; Instruction:inCMP; Ticks:4),
    {D6} (Mode:amZEX; Instruction:inDEC; Ticks:6),
    {D7} (Instruction:inNIL),
    {D8} (Mode:amIMP; Instruction:inCLD; Ticks:2),
    {D9} (Mode:amABY; Instruction:inCMP; Ticks:4; Penalty:ipPageCross),
    {DA} (Mode:amIMP; Instruction:inPHX; Ticks:3),
    {DB} (Instruction:inNIL),
    {DC} (Instruction:inNIL),
    {DD} (Mode:amABX; Instruction:inCMP; Ticks:4; Penalty:ipPageCross),
    {DE} (Mode:amABX; Instruction:inDEC; Ticks:7),
    {DF} (Instruction:inNIL),
    {E0} (Mode:amIMM; Instruction:inCPX; Ticks:2),
    {E1} (Mode:amINX; Instruction:inSBC; Ticks:6),
    {E2} (Instruction:inNIL),
    {E3} (Instruction:inNIL),
    {E4} (Mode:amZER; Instruction:inCPX; Ticks:3),
    {E5} (Mode:amZER; Instruction:inSBC; Ticks:3),
    {E6} (Mode:amZER; Instruction:inINC; Ticks:5),
    {E7} (Instruction:inNIL),
    {E8} (Mode:amIMP; Instruction:inINX; Ticks:2),
    {E9} (Mode:amIMM; Instruction:inSBC; Ticks:2),
    {EA} (Mode:amIMP; Instruction:inNOP; Ticks:2),
    {EB} (Instruction:inNIL),
    {EC} (Mode:amABS; Instruction:inCPX; Ticks:4),
    {ED} (Mode:amABS; Instruction:inSBC; Ticks:4),
    {EE} (Mode:amABS; Instruction:inINC; Ticks:6),
    ...
    {F5} (Mode:amZEX; Instruction:inSBC; Ticks:4),
    {F6} (Mode:amZEX; Instruction:inINC; Ticks:6),
    {F7} (Instruction:inNIL),
    {F8} (Mode:amIMP; Instruction:inSED; Ticks:2),
    ...
    {FE} (Mode:amABX; Instruction:inINC; Ticks:7),
